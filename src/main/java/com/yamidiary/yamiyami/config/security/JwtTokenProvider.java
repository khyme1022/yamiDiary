...
public class JwtTokenProvider {
    ...
    private final long tokenValidMillisecond = 1000L * 60 * 60; // 토큰 생성에 사용할 secretKey와 토큰 유효시간 설정(1000ms * 60 * 60 = 1시간)
    ...
    public String createToken(String email, List<String> roles){
        ...
        String token = Jwts.builder()
                ...
                .signWith(SignatureAlgorithm.HS256,secretKey) // 서명  추가
                .compact(); // 반환
